...
-- FIX 1: NVARCHAR(20) → NVARCHAR(30) para que quepan todos los valores del CHECK
...
-- FIX 2: Añadido 'Movilidad Reducida' al CHECK y ampliado a NVARCHAR(30)
ALTER TABLE Usuarios 
...
-- ─────────────────────────────────────────────────────────────────────────────
-- PAQUETES_TURISTICOS  (paquete_id 1..8, creado por operador usuario_id=2)
-- ─────────────────────────────────────────────────────────────────────────────
...
('Ruta del Mediterraneo',    'Crucero por Mallorca, Ibiza y Valencia.',                 'Mallorca, España',    6,  980.00, 'Crucero, Cabina, Pension completa', 'General',     1, 2),
...
-- pedido_id 25  ← original tenía --27
( 9, 3, 1200.00, 'Cancelado',   'PayPal',        '2025-05-21', NULL,          NULL),
-- pedido_id 26  ← original tenía --28
...
(16, 'Transporte',        'Cancelacion de tren sin reembolso inmediato.',                           '2025-03-19', 'En revisión'),  -- FIX: era 15
...
(15, 'Confirmado', 'Reembolsado',  'Paquete no disponible en fecha solicitada.',              2),  -- FIX: era 16
(19, 'Pendiente',  'Confirmado',   'Confirmado tras verificacion de disponibilidad.',         2),  -- FIX: era 20
(21, 'Confirmado', 'Pagado',       'Pago recibido por transferencia bancaria.',               2),  -- FIX: era 22
(25, 'Pendiente',  'Cancelado',    'Cliente cancelo antes del plazo de confirmacion.',        2);  -- FIX: era 27
