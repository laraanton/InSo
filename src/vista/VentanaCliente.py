...
class VentanaCliente(QMainWindow, Form):
    ...
    def _cargar_paquetes(self):
        # Limpia el grid antes de repoblarlo para evitar tarjetas duplicadas
    ...
    def _crear_tarjeta(self, p: dict):
        ...
        # Muestra servicios si los hay; si no, los primeros 40 caracteres de la descripción
        ...
        # pid se captura en el closure para evitar que el bucle lo sobreescriba
        pid = p["id"]
    ...
    def _abrir_cuenta(self):
        # Alterna la visibilidad del menú desplegable de cuenta
